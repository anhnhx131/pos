...
# Parse arguments
BOOTNODE_IP="${1:-$GETH_BOOTNODE_IP}"
BOOTNODE_NAME="${2:-geth-bootnode}"
BOOTNODE_KEY="${3:-$GETH_BOOTNODE_KEY}"
...
log_info "Bootnode enode will be available at: enode://[PUBKEY]@${BOOTNODE_IP}:30303"
