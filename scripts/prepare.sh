  ...
  cat >"$target"<<EOF
{
  "config": {
    ...
    "terminalTotalDifficulty": ${EL_TERMINAL_TOTAL_DIFFICULTY:-100},
  ...
  "nonce": "${EL_NONCE:-0x0}",
  "timestamp": "${EL_TIMESTAMP:-0x0}",
  "extraData": "${EL_EXTRA_DATA:-0x0}",
...
TERMINAL_TOTAL_DIFFICULTY: ${CL_TERMINAL_TOTAL_DIFFICULTY:-0}
TERMINAL_BLOCK_HASH: ${CL_TERMINAL_BLOCK_HASH:-0x0}
...
CAPELLA_FORK_EPOCH: ${CL_CAPELLA_FORK_EPOCH:-1}
DENEB_FORK_VERSION: ${CL_DENEB_FORK_VERSION:-0x04000000}
DENEB_FORK_EPOCH: ${CL_DENEB_FORK_EPOCH:-1}
ELECTRA_FORK_VERSION: ${CL_ELECTRA_FORK_VERSION:-0x05000000}
ELECTRA_FORK_EPOCH: ${CL_ELECTRA_FORK_EPOCH:-1}
